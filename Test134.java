/*===============================
  ...
  ===============================*/
/*
○ StringBuffer클래스는 문자열을 처리하는 클래스로
   String 클래스와의 차이점은
   String 클래스는 내부 문자열 데이터의 수정이 불가능하지만
   StringBuffer 클래스는 문자열을 사용할 때
   내부 문자열을 실행단계(런타임 시점)에서 변경할 수 있다.
   ...
   실행 시점에 버퍼의 크기를 바꿀 수 있는 기능을 제공한다.
	...
	StringBuilder클래스의 기능은 StringBuffer클래스와 동일하지만
...
public class Test134{
	public static void main(String[]args){
		...
		//-- StringBuffer기본 생성자 호출 시(인스턴스 생성과정)
		...
		*/
		...
		// ○ 대상 문자열(sb3)중 seoul앞에
		//	  『"한국"』이라는 문자열 추가
		sb3.insert(0,"한국");
		System.out.println("seoul앞에 『한국』 추가 : "+ sb3.toString());
