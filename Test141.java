...
※ java.lang.Math 클래스는
   ...
   생성자가 있긴 하지만... 『private』으로 선언되어 있기 때문에 외부에서 객체(인스턴스)를 생성할 수 없다.
   단, 모든 메소드가 『static』으로 정의되어 있으므로 객체를 생성하지 않고 바로 접근하여 사용하는 것이 가능하다.	
...
public class Test141{
	public static void main(String[]args){
		...
		//--==>> 0.0 ~ 1.0 사이의 난수 : 0.46580893063436424
		//		0.0 ~ 1.0 사이의 난수 : 0.08091476101132666
		//		0.0 ~ 1.0 사이의 난수 : 0.8450566636463145
		//		0.0 ~ 1.0 사이의 난수 : 0.4771642880161323
		//		0.0 ~ 1.0 사이의 난수 : 0.8236433790193043
		//		0.0 ~ 1.0 사이의 난수 : 0.027674878053692065
		//		0.0 ~ 1.0 사이의 난수 : 0.5647184170694911
		//		0.0 ~ 1.0 사이의 난수 : 0.014078844279647562
		//		0.0 ~ 1.0 사이의 난수 : 0.9249722613344964
		//		0.0 ~ 1.0 사이의 난수 : 0.28672659205141915
